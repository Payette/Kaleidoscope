...
import dataGWP from './wall/wall_gwp_10y_n.csv';
import dataAllImpacts from './wall/wall_allImpact_10y_n.csv';
import dataLCS from './wall/wall_lcs_10y_n.csv';
import dataMaterial from './wall/wall_material_10y_n.csv';

import dataGWP1 from './wall/wall_gwp_10y_y.csv';
import dataAllImpacts1 from './wall/wall_allImpact_10y_y.csv';
import dataLCS1 from './wall/wall_lcs_10y_y.csv';
import dataMaterial1 from './wall/wall_material_10y_y.csv';

import dataGWP2 from './wall/wall_gwp_60y_n.csv';
import dataAllImpacts2 from './wall/wall_allImpact_60y_n.csv';
import dataLCS2 from './wall/wall_lcs_60y_n.csv';
import dataMaterial2 from './wall/wall_material_60y_n.csv';

import dataGWP3 from './wall/wall_gwp_60y_y.csv';
import dataAllImpacts3 from './wall/wall_allImpact_60y_y.csv';
import dataLCS3 from './wall/wall_lcs_60y_y.csv';
import dataMaterial3 from './wall/wall_material_60y_y.csv';

import dataGWP4 from './wall/wall_gwp_60yd_n.csv';
import dataAllImpacts4 from './wall/wall_allImpact_60yd_n.csv';
import dataLCS4 from './wall/wall_lcs_60yd_n.csv';
import dataMaterial4 from './wall/wall_material_60yd_n.csv';

import dataGWP5 from './wall/wall_gwp_60yd_y.csv';
import dataAllImpacts5 from './wall/wall_allImpact_60yd_y.csv';
import dataLCS5 from './wall/wall_lcs_60yd_y.csv';
import dataMaterial5 from './wall/wall_material_60yd_y.csv';
...
const metaData = {
  ...
  materialTexts: {
    ...
    cFiberglassTrim: 'Free-hanging cloud, 5/8" fiberglass acoustical wall panel with aluminum trim, steel suspension grid, steel cable',
    cFiberglass: 'Free-hanging cloud, 7/8" fiberglass acoustical wall panel, steel suspension grid, steel cable',
    ltFiberglass: '5/8" fiberglass acoustical wall panel, steel suspension grid, steel cable',
    ltMineralBoard: '5/8" mineral fiber acoustical wall panel, steel suspension grid, steel cable',
  ...
  materialNotes: {
    ...
    'Service life 50 year Tally default and some materials adjusted to match',
    'Wall tile is pre-finished',
    '2" extruded aluminum trim',
    'Ratio of trim to wall tile area is 1 linear foot:1 square foot',
  ...
  sectionIcons: {
    mBaffle: "./img/Wall/Sections/M-BAFFLE.png",
    mPan: "./img/Wall/Sections/M-PAN.png",
    mPerforatedPan: "./img/Wall/Sections/M-PERFORATEDPAN.png",
    hcGypsum: "./img/Wall/Sections/HC-GYPSUM.png",
    hcMoistureResistantGyp: "./img/Wall/Sections/HC-MOISTURERESISTANTGYPSUM.png",
    cFiberglassTrim: "./img/Wall/Sections/C-FIBERGLASSWTRIM.png",
    cFiberglass: "./img/Wall/Sections/C-FIBERGLASS.png",
    ltFiberglass: "./img/Wall/Sections/LT-FIBERGLASS.png",
    ltMineralBoard: "./img/Wall/Sections/LT-MINERALBOARD.png",
    ocAcousticalSpray: "./img/Wall/Sections/OC-ACOUSTICALSPRAY.png",
    ocPaint: "./img/Wall/Sections/OC-PAINT.png",
    wVeneerDense: "./img/Wall/Sections/W-DENSEGRILLEVENEER.png",
    wVeneerOpen: "./img/Wall/Sections/W-OPENGRILLEVENEER.png",
    wPoplarDense: "./img/Wall/Sections/W-DENSEGRILLEPOPLAR.png",
    wPoplarOpen: "./img/Wall/Sections/W-OPENGRILLEPOPLAR.png",
    wWalnutDense: "./img/Wall/Sections/W-DENSEGRILLEWALNUT.png",
    wWalnutOpen: "./img/Wall/Sections/W-OPENGRILLEWALNUT.png",
    wMapleDense: "./img/Wall/Sections/W-DENSEGRILLEMAPLE.png",
    wMapleOpen: "./img/Wall/Sections/W-OPENGRILLEMAPLE.png",
  },
  ...
  materialName2: {
    ...
    hcGypsum: "Hard Wall - Gypsum",
    hcMoistureResistantGyp: "Hard Wall - Moisture Resistant Gypsum",
    ...
    ocAcousticalSpray: "Open Wall - Acoustical Spray",
    ocPaint: "Open Wall - Paint",
