...
let colsCeilings = [ "#CCCCCC", "#666666", "#999999", "#666666", "#C2EAA7", "#C2EAA7", "#89EFC0", "#89EFC0", "#C2EAA7", "#FEE6BF", "#FCC05E", "#C2EAA7", "#89EFC0", "#89EFC0", "#89EFC0", "#89EFC0", "#C2EAA7", "#89EFC0", "#89EFC0", "#89EFC0", "#5CBDFF", "#00AAFF", "#4169E1", "#4169E1", "#000099" ];
      ...
      <>
        <div>
          ...
          <div>
            ...
            {/* Create clear button for Deselect All, needs work <button className={styles.mButton} onClick={e => this.handleSelectAll.bind(this)(e)}>Clear</button> */}
