...
let colsPartitions = [ "#666666","#666666","#89EFC0","#89EFC0","#C2EAA7","#89EFC0","#FFB65B","#FFB65B","#FFB65B","#FFB65B","#5CBDFF","#C1E9EC","#87CEE9","#8BD3F7","#5CBDFF","#4169E1","#4169E1","#4169E1","#000099","#000099","#000099","#000099"];
...
export default class MaterialList extends PureComponent {
  ...
  reRreshSelect(e){
    ...
    this.props.updateSelectedMaterials([]);
  }
  ...
  render() {
    ...
    if (this.props.currentSel === "GWP") {
      ...
      legend = legendGWP;
      legendText = <div className={styles.serif}><p> <span style={{ background: "#87cee9" }}> &nbsp; &nbsp; &nbsp; </span> &nbsp; Global Warming Potential (kgCO<sub>2</sub>eq/lf)</p> <p> <span style={{ background: "#6495ed" }}> &nbsp; &nbsp; &nbsp; </span> &nbsp; Non-Renewable Energy Demand (MJ/lf)</p><p> <span style={{ background: "#fcc05e" }}> &nbsp; &nbsp; &nbsp; </span> &nbsp; Eutrophication Potential (kgNeq/lf)</p> <p> <span style={{ background: "#0090ff" }}> &nbsp; &nbsp; &nbsp; </span> &nbsp; Smog Formation Potential (kgO<sub>3</sub>eq/lf)</p><p> <span style={{ background: "#85e2bd" }}> &nbsp; &nbsp; &nbsp; </span> &nbsp; Acidification Potential (kgSO<sub>2</sub>eq/lf)</p> <p> <span style={{ background: "#283cdc" }}> &nbsp; &nbsp; &nbsp; </span> &nbsp; Ozone Depletion Potential (CFC-11eq/lf)</p></div>
      ...
      if (this.props.type === SYSTEM_TYPE_PARTITIONS) {
        legendText = <div className={styles.serif}>
          <img style={{ maxWidth: "320px" }} src={legend} />
            <p><span style={{ background: "#4169e1" }}> &nbsp; &nbsp; &nbsp; </span> &nbsp; Support System </p>
