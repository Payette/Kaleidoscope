    ...
    return $.bigfoot = function(options) {
      ...
      footnoteInit = function() {
        ...
        $(footnoteLinks).each(function() {
          ...
          // if(localStorage.getItem('myFootnotes')){
          //   footnotes = JSON.parse(localStorage.getItem('myFootnotes'))
          // }else{
        ...
        // localStorage.setItem('myFootnotes', JSON.stringify(footnotes[0]))
        // console.log(footnotes[0][0])
